...
| get | /registration | "content-tyoe", Authorization | - | 200 ok | { registId: registration.id, userId: users.id, classId: classes.id }
| get | /registration | "content-tyoe", Authorization | - | 400 bad request | - |
| post | /registration | "content-tyoe", Authorization  | { registId: registration.id, userId: users.id, classId: classes.id } | 201 created | - |   
| post | /registration | "content-tyoe", Authorization | { registId: registration.id, userId: users.userId, classId: classes.classId } | 400 bad request | - |  
| post | /classes/{role}/users/{role} | "content-tyoe", Authorization | { classId: classid, title: className, professorName: name, subjectOutline: subjectName, role: roleId} | 201 created |-|  
| put | /users/{email} | "content-tyoe", Authorization | { userId: id, role: roleid, userName: name, email: emailName } | 201 created | - |   
| put | /users/{email} | "content-tyoe", Authorization | { userId: id, role: roleid, userName: name, email: emailName } | 400 bad request | - |      
| delete | /registration/{userId}/classes/{classId} | "content-tyoe", Authorization | - | 200 ok | - |     
