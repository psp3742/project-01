...
| put | /users/{email} | "content-type" : "application/json", Authorization | { userName: name } | 201 created | - |   
| put | /users/{email} | "content-type" : "application/json", Authorization | { userName: name } | 400 bad request | - |      
