...
| post | /classes ? users.role = classes.role | "content-type" : "application/json", Authorization | { classId: classid, title: className, professorName: name, subjectOutline: subjectName, role: roleId} | 201 created |-|  
