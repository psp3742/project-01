...
| post | /registration | "content-type" : "application/json", Authorization  | { userId: users.userid, classId: classes.id } | 201 created | - |   
| post | /registration | "content-type" : "application/json", Authorization | { userId: users.userId, classId: classes.classId } | 400 bad request | - |  
| post | /classes/{classes.role} | "content-type" : "application/json", Authorization | { classId: classid, title: className, professorName: name, subjectOutline: subjectName} | 201 created |-|  
| put | /users/{email} | "content-type" : "application/json", Authorization | { role: roleid, userName: name } | 201 created | - |   
| put | /users/{email} | "content-type" : "application/json", Authorization | { role: roleid, userName: name } | 400 bad request | - |      
